...
import com.trulioo.normalizedapi.auth.HttpBearerAuth;
import com.trulioo.normalizedapi.auth.ApiKeyAuth;
import com.trulioo.normalizedapi.auth.OAuth;
import com.trulioo.normalizedapi.auth.RetryingOAuth;
import com.trulioo.normalizedapi.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://api.trulioo.com
     ...
     * @return a {@link com.trulioo.normalizedapi.ApiClient} object
     */
     ...
     * @throws com.trulioo.normalizedapi.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.trulioo.normalizedapi.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.trulioo.normalizedapi.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.trulioo.normalizedapi.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.trulioo.normalizedapi.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.trulioo.normalizedapi.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.trulioo.normalizedapi.ApiException If fails to update the parameters
     */
     ...
     * @throws com.trulioo.normalizedapi.ApiException If fail to serialize the request body object into a string
     */
